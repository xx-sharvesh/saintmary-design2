  ...
  if (live.isLive) {
    el.innerHTML = `
      <div class="live-inner">
        ...
        <h2>${esc(live.title || 'Live Service')}</h2>
        <span class="live-badge">● Live Now</span>
        <div class="live-frame">
          <iframe src="https://www.youtube.com/embed/${esc(live.youtubeId)}?autoplay=1&rel=0"
    ...
    el.innerHTML = `
      <div class="live-inner">
        ...
        <p style="color:rgba(255,255,255,0.5); font-size:0.88rem;">Stream not currently active. Check back at service time.</p>
      </div>
    `;
  }
}
